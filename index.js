  ...
  try {
    ...
    if (messages && messages.length > 0) {
      ...
      for (const message of messages) {
        ...
        console.log("in this Email", toEmail);
        ...
        if (replies.length === 0) {
          ...
          const labelName = "MailsDuringVacation";
...
async function createReplyRaw(from, to, subject) {
  const emailContent = `From: ${from}\nTo: ${to}\nSubject: ${subject}\n\nHey, Thanks for reaching out! I'm unavailable for some time, I might not be able to respond right away, but I'll get back to you as soon as I can. Appreciate your understanding!`;
